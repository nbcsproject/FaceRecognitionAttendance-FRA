$(document).ready(function () {
    const checkList_url = '/main/check_list?byPage=true&'
    ...
    $('#showAll').click(function () {
        window.location.href = checkList_url + 'page=1'
    })
    ...
    $("#firstPage").click(function () {
        ...
        if (currentPage === 1) {
            ...
            // 如果不是首页跳转到首页
            window.location.href = checkList_url + 'page=1&searchText=' + getSearchText();
        }
    });
    ...
    $("#prePage").click(function () {
        ...
        if (currentPage === 1) {
            ...
            // 如果不是首页跳转到首页
            window.location.href = checkList_url + 'page=' + (currentPage - 1) + '&searchText=' + getSearchText();
        }
    });
    ...
    $("#lastPage").click(function () {
        ...
        if (currentPage === totalPage) {
            ...
            // 如果不是尾页跳转到尾页
            window.location.href = checkList_url + 'page=' + totalPage + '&searchText=' + getSearchText();
        }
    });
    ...
    $("#jumpInputPage").click(function () {
        ...
        if (!isNaN(inputPage)) {
            if (inputPage < 1 || inputPage > totalPage) {
                ...
                // 跳转到指定页
                window.location.href = checkList_url + 'page=' + inputPage + '&searchText=' + getSearchText();
            }
        } else {
            myAlert("请输入合适的页数！！", function () {
            })
                ...
                success: function (data) {
                    ...
                    if (err_code === 0) {
                        ...
                        for (var i = 0; i < users.length; i++) {
                            var sex = ''
                            var checktime_text = users[i].check_time
                            ...
                            var htmlText = '<tr><td><input type="checkbox"name="IDCheck"value=' + users[i].uid + '/></td><td>' + users[i].uid + '</td><td>' + users[i].name + '</td><td><span class="' + users[i].gender + '">' + sex + '</span></td><td>' + users[i].department + '</td><td><span>' + checktime_text + '</span></td><td><a href="javascript:"id="' + users[i].uid + '"class="delete">删除</a></td></tr>'
